                      ...
                      child: Column(
                        children: [
                          Container(
                            decoration: BoxDecoration(
                              border: Border(
                                bottom: BorderSide(color: Colors.green.shade50),
                              ),
                            ),
                            child: TextFormField(
                  ...
                  ElevatedButton(
                        ...
                        try {
                          ...
                          if (result == "Giriş Başarılı") {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content:
                                    Text("Giriş işlemi başarısız: $result"),
                              ),
                            );
                          }
                        } catch (error) {
                    ...
                    style: ElevatedButton.styleFrom(
                      ...
                      backgroundColor: Colors
                          .green.shade600, // Butonun arka plan rengini ayarlar
                    ),
                    child: const Text(
                      "Giriş Yap",
                      style: TextStyle(
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      ...
                      shape: RoundedRectangleBorder(
                        ...
                        side: BorderSide(
                            color: Colors.green.shade600), // Kenarlık rengi
                      ),
                    ...
                    child: Text(
                      "Kayıt Ol",
                      style: TextStyle(
                        color: Colors.green.shade600, // Buton yazı rengi
                        fontWeight: FontWeight.bold,
                        fontSize: 16,
                      ),
                    ),
